		...
		public function create_admin_page() {
			...
			<div class="wrap about-wrap">
				...
				<div class="welcome-panel pbs-welcome-changelog">
					...
					<ul>
<li style="color: #e74c3c"><code>Fixed</code> Security fix</li>
<li style="color: #e74c3c"><code>Fixed</code> Blank Page templates override the search page's template</li>
<li style="color: #e74c3c"><code>Fixed</code> Better checking method for the Block Editor</li>
					</ul>
				</div>
			</div>
			<?php
